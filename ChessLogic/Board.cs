    ...
    public class Board
    {
        ...
        private static bool IsKingBishopVKing(Counting counting)
        {
            return counting.TotalCount == 3 &&
                   (counting.White(PieceType.Bishop) == 1 ||
        ...
        {
            return counting.TotalCount == 3 &&
                   (counting.White(PieceType.Knight) == 1 ||
                    counting.Black(PieceType.Knight) == 1);
        }

        private bool IsKingBishopsVKing(Counting counting)
        {
        ...
        {
            var skip = GetPawnSkipPosition(player.Opponent());
            if (skip == null)
            {
                return false;
            }
